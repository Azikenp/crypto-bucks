          ...
          <div className="flex items-center justify-between h-full w-full p-4">
            <div className="flex flex-col w-[45%] h-full pr-2">
              <div className="flex w-full items-center">
                ...
                <span className="text-sm py-0.5 px-2.5 ml-2 bg-cyan bg-opacity-25 text-cyan rounded uppercase">
                  {data.symbol}
                </span>
              </div>
              ...
              <div className="flex w-full mt-6">
                <div className="flex flex-col w-full">
                  <div className="flex justify-between ">
                    ...
                    <div
                      className={`text-sm px-1 ml-1 font-medium flex items-center rounded uppercase bg-opacity-25 ${
                    ...
                    >
                      ...
                      <svg
                        ...
                        className={
                          `w-[1rem] ml-0.5 ${data.market_data.price_change_percentage_24h > 0
              ...
              <div>
                ...
                <div>
                  ...
                  <h2>{new Intl.NumberFormat("en-IN", {
                      ...
                      currency: currency,
                      maximumSignificantDigits: 5,
                    }).format(data.market_data.full_diluted_valuation[currency])}</h2>
                </div>
              </div>
